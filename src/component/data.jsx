...
function Data({ user, repo }) {
  if (!user.name) {
    return (
      <h1 className="text-red-600 p-10 text-5xl capitalize text-center">
        user not found!!!
      </h1>
    );
  }
  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-items-center items-center flex-col">
        <img src={user.avatar_url} alt="avatar" className="rounded-full h-44" />
        <h1 className="pt-3 text-2xl">{user.name}</h1>
        <a href={user.html_url} className="text-blue-600 mt-8">
          {user.login}
        </a>
      </div>
      <div className=" m-12 flex justify-center items-center space-x-12">
      ...
      <div className="flex content-around flex-wrap">
        <div className="w-1/3 h-2/5 mx-16">
          <h1>Activity</h1>
          <Bar
            data={{
              labels: title,
        ...
        <div className="w-1/4 h-2/5 mx-16">
          <Doughnut
            data={{
      ...
      <div className="text-center">
        ...
        <div className="flex flex-wrap space-x-4 p-2 justify-center ">
          {repo.slice(0, 7).map((data) => {
            return (
              <div className="shadow-xl p-10 mt-14 w-1/4 ">
